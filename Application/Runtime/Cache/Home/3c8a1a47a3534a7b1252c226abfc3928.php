...
<div class="editor-preview-side editor-preview-active-side" style="width: 100%;height: auto;position: static;z-index: 0;background-color: rgb(229, 233, 239);border:0;">
    <div class="col-md-12 column">
        <h2>
            <?php echo ($articleDetail['title']); ?>
        </h2>
        <p><font class="label label-success" style="border-radius: 0">php</font><font class="label label-default" style="border-radius: 0">2017-02-25 21:41:13 周六 晴 张亮</font></p>
        <div class="article_body">
            <?php echo (html_entity_decode($articleDetail['content'])); ?>
        </div>
    </div>
</div>
	<div id="SOHUCS" sid="<?php echo ($articleDetail['article_id']); ?>"></div>


<script type="text/javascript">
    var _CONTROLLER_ = '/index.php/Home/Article';
    var _ACTION_ = '/index.php/Home/Article/detail';
    var _ROOT_ = '';
</script>
