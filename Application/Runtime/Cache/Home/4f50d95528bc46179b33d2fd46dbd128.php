...
<div class="container" style="margin-top: 50px;">
	...
	<?php if(is_array($yaowenList)): foreach($yaowenList as $key=>$yaowen): ?><div style="width:100%;margin-top: 10px;height:90px;background-color: white">
			<div style="width:10%;float: left;padding: 10px;">
				<a href="<?php echo ($yaowen['url']); ?>" target="_blank">
					<img style="height: 70px;width: 100px;" src="<?php echo ($yaowen['picUrl']); ?>">
				</a>
			</div>

			<div style="width:90%;float: left;padding-top: 30px;padding-left: 20px;">
				<p style="font-size: 16px;font-weight: bolder"><a target="_blank" href="<?php echo ($yaowen['url']); ?>"><?php echo ($yaowen['title']); ?></a></p>
				<p>
					来源：<?php echo ($yaowen['description']); ?>&nbsp;&nbsp;&nbsp;<?php echo ($yaowen['ctime']); ?>
				</p>
				</p>
			</div>
		</div><?php endforeach; endif; ?>
	<div id="SOHUCS" sid="yaowen_list"></div>


<script type="text/javascript">
    var _CONTROLLER_ = '/index.php/Home/DailyPie';
    var _ACTION_ = '/index.php/Home/DailyPie/yaowen';
    var _ROOT_ = '';
</script>
