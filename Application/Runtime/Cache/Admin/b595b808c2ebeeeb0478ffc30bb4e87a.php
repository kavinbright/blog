...
<script src="/Public/plugins/layer/layer.js"></script>
    <!--<script src="/Public/admin/js/jquery.min.js?v=1.9.1"></script>
    <script src="/Public/admin/js/bootstrap.min.js?v=3.3.5"></script>-->
    <script src="/Public/admin/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/Public/admin/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="/Public/admin/plugins/layer/layer.min.js"></script>
    <script src="/Public/admin/js/hplus.min.js?v=4.0.0"></script>
    <script type="text/javascript" src="/Public/admin/js/contabs.min.js"></script>
    <script src="/Public/admin/plugins/pace/pace.min.js"></script>
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="/Public/admin/images/profile_small.jpg" /></span>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">内容系统</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="/ArticleCategory/lists">主题设置</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/Article/lists">文章管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/IndexDisplay/lists">主页布局</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/Article/addMarkdown">Mardown</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" style="width:100%;height:100%;" src="index_v1.html?v=4.0" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/admin/images/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/admin/images/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/admin/images/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/admin/images/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/admin/images/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/admin/images/a7.jpg">
                                    </div>
                                    <div class="media-body">
...
<script type="text/javascript">
    ...
    var _ACTION_ = '/index.php/Index/index';
    var _ROOT_ = '';
</script>
